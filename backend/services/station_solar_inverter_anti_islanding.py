"""
CityBus Enterprise Platform - Grid Loss Anti-Islanding Protection & Emergency Power Transfer Switch
File: backend/services/station_solar_inverter_anti_islanding.py
...
class StationSolarInverterAntiIslanding:
    """Enterprise domain service implementing Grid Loss Anti-Islanding Protection & Emergency Power Transfer Switch."""
    ...
    def get_service_metadata(cls) -> Dict[str, Any]:
        ...
        return {
            "service_name": "StationSolarInverterAntiIslanding",
            "description": "Grid Loss Anti-Islanding Protection & Emergency Power Transfer Switch",
    ...
    def execute_operation(cls, entity_id: int, parameters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        AuditRepository.log_event("STATIONSOLARINVERTERANTIISLANDING_EXECUTE", "StationSolarInverterAntiIslanding", entity_id, None, None, f"Params: {params}")
        
        return {
            "success": True,
            "entity_id": entity_id,
            "service": "StationSolarInverterAntiIslanding",
