"""
CityBus Enterprise Platform - NCMC Cryptographic Key Exchange & Mutual Authentication Protocol
File: backend/services/smart_card_ncmc_security_protocol.py
...
class SmartCardNCMCSecurityProtocol:
    """Enterprise domain service implementing NCMC Cryptographic Key Exchange & Mutual Authentication Protocol."""
    ...
    def get_service_metadata(cls) -> Dict[str, Any]:
        ...
        return {
            "service_name": "SmartCardNCMCSecurityProtocol",
            "description": "NCMC Cryptographic Key Exchange & Mutual Authentication Protocol",
