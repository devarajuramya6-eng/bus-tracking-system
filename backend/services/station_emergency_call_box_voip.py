"""
CityBus Enterprise Platform - Platform Emergency Help Call Point SIP / VoIP Audio Telephony Gateway
File: backend/services/station_emergency_call_box_voip.py
...
class StationEmergencyCallBoxVoIP:
    """Enterprise domain service implementing Platform Emergency Help Call Point SIP / VoIP Audio Telephony Gateway."""
    ...
    def get_service_metadata(cls) -> Dict[str, Any]:
        ...
        return {
            "service_name": "StationEmergencyCallBoxVoIP",
            "description": "Platform Emergency Help Call Point SIP / VoIP Audio Telephony Gateway",
    ...
    def execute_operation(cls, entity_id: int, parameters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        AuditRepository.log_event("STATIONEMERGENCYCALLBOXVOIP_EXECUTE", "StationEmergencyCallBoxVoIP", entity_id, None, None, f"Params: {params}")
        
        return {
            "success": True,
            "entity_id": entity_id,
            "service": "StationEmergencyCallBoxVoIP",
